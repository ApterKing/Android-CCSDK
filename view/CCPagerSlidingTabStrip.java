 ...
 * 用于ViewPager顶部可滑动的选项块，使用方式类似于android.support.v4.view.PagerTabStrip
 * 代码中：
 *      CCPagerSlidingTabStrip tabStrip = ...
 *      ViewPager pager = ...
 ...
 *
 */
public class CCPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public CCPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public CCPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CCPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
...
//        textView.setTextIsSelectable(true);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CCPagerTabProvider) {
                tabView = ((CCPagerTabProvider) pager.getAdapter()).getCustomTabView(this, i);
            } else {
                // 修改这里
